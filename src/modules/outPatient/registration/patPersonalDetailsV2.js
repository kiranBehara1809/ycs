...
const PatientPersonalDetailsV2 = (props) => {
  ...
  const [formValues, setFormValues] = useState({
    salutation: props?.selObj?.salutation || null,
    gender: props?.selObj?.gender || null,
    bloodGroup: props?.selObj?.bloodGroup || null,
    firstName: props?.selObj?.firstName || "",
    middleName: props?.selObj?.middleName || "",
    lastName: props?.selObj?.lastName || "",
    dateOfBirth: props?.selObj?.dateOfBirth || "",
    mobileNo: props?.selObj?.mobileNo || "",
  });
...
export default PatientPersonalDetailsV2;
